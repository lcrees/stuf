...
class OrderedDict(dict):
    ...
    def __setitem__(self, key, value, dict_setitem=dict.__setitem__):
        ...
        if key not in self:
            root = self._root
            last = root[0]
            last[1] = root[0] = self._map[key] = [last, root, key]
    ...
    def update(self, *args, **kwds):
        ...
        for key, value in kwds.items(): self[key] = value
    ...
    def pop(self, key, default=__marker):
        ...
        if key in self:
            ...
            del self[key]
            return result
        if default is self.__marker: raise KeyError(key)
        return default
    ...
    def __reduce__(self):
        ...
        for k in vars(OrderedDict()): inst_dict.pop(k, None)
